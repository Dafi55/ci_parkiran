...
session_start();
include '../koneksi/koneksi.php'; // pastikan pathnya betul
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Data berhasil disimpan'); window.location.href='pages-account-settings-account.php';</script>";
    } else {
