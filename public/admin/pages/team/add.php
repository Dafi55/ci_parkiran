...
$result = mysqli_query($conn, "INSERT INTO user (nama_user, jenis_kelamin, no_hp, alamat, jabatan, tgl_lahir, username, password, foto) VALUES ('$nama_user', '$jenis_kelamin', '$no_hp', '$alamat', '$jabatan', '$tgl_lahir', '$username', '$password', '$foto')");
