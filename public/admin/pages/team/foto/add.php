...
if(isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO user (nama_user, jenis_kelamin, no_hp, alamat, jabatan, tgl_lahir, foto) VALUES ('$nama_user', '$jenis_kelamin', '$no_hp', '$jabatan', '$alamat', '$tgl_lahir', '$foto')");
                  ...
                  <div class="card mb-4">
                    ...
                    <select id="jenis_kelamin" name="jenis_kelamin" class="form-control custom-select">
                      ...
                      <option value="PEREMPUAN">Perempuan</option>
                        ...
                        <div class="form-group">
                      <label class="form-label" for="jabatan">Tanggal Lahir</label>
