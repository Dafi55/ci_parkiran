...
if(isset($_POST['submit'])) {
  ...
  // upload foto ke folder
    ...
    $result = mysqli_query($conn, "INSERT INTO produk (nama_produk, harga, foto, deskripsi_produk, stok) 
    VALUES ('$nama_produk', '$harga', '$foto', '$deskripsi_produk', '$stok')");
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <input type="text" class="form-control" id="deskripsi_produk" name="deskripsi_produk"  value=""/>
                      </div>
