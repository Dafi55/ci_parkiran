                  ...
                  <div class="table-responsive text-nowrap">
                    <table id= "table" class="table table-bordered">
                      ...
                      while($user_data = mysqli_fetch_array($result)) {
                          ...
                          echo "</td>";
                          echo "<td>".$user_data['deskripsi_produk']."</td>";
                          echo "<td>".$user_data['stok']."</td>";
                          echo "<td>
                          <a href='hapus.php?id_produk=$user_data[id_produk]' class='btn btn-outline-danger btn-sm'>Hapus</a> 
                          <a href='edit.php?id_produk=$user_data[id_produk]' class='btn btn-outline-success btn-sm'>Edit</a>
                          </td>";
